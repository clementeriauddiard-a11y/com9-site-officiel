  ...
  return (
    ...
    <Link href={`/marketplace/${phone.id}`} className="flex flex-col flex-1 min-w-0" style={{ textDecoration: 'none' }}>
      ...
      <div className="flex flex-col flex-1 p-4 gap-3.5">
        ...
        {/* Prix */}
        <div className="mt-auto pt-3" style={{ borderTop: '1px solid rgba(0,209,255,0.07)' }}>
    ...
    </Link>{/* ← fin du lien carte */}

      {/* Prix + CTA — EN DEHORS du Link pour éviter les conflits de navigation */}
      <div className="px-4 pb-4 flex items-center justify-between gap-3">
        {/* Indicateur "Voir la fiche" */}
        <span className="font-mono text-[8.5px] tracking-[0.18em] uppercase flex items-center gap-1"
